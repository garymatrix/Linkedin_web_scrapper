...
## Types of errors encountered while executing the code, The script is working, but the error still persits due to lack of r_liteprofile permission by the Linkedin's api, there seems to be a verification process for the r_liteprofile permission which I am unable to get on my application:
